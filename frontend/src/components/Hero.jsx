...
export const Hero = () => {
  return (
    <section className="relative flex min-h-[66vh] items-center overflow-hidden pt-4 sm:pt-8 md:pt-10 lg:min-h-[56vh] lg:pb-12 xl:min-h-[62vh]">
        ...
        <div className="hero-fade-up hero-delay-2 flex w-full justify-center xl:justify-end">
          <div className="relative w-full max-w-lg">
            ...
            <img
              ...
              className="hero-float-soft pointer-events-none absolute -bottom-2 left-2 h-42.5 w-[48%] object-contain opacity-90 sm:h-50 sm:w-[44%] md:h-55 md:w-[42%] lg:h-52.5 lg:w-[40%]"
            />
          </div>
        </div>
      </div>
